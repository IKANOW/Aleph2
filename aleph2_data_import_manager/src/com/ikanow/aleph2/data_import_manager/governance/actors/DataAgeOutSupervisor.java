...
public class DataAgeOutSupervisor extends UntypedActor {
	...
	//logging mgmt schema fields
	final protected static MethodNamingHelper<ManagementSchemaBean> _logging_fields = BeanTemplateUtils.from(DataBucketBean.class).nested(DataBucketBean::management_schema, ManagementSchemaBean.class);
	final protected static MethodNamingHelper<DataSchemaBean.TemporalSchemaBean> _time_fields_logging = _logging_fields.nested(ManagementSchemaBean::temporal_schema, DataSchemaBean.TemporalSchemaBean.class);
	final protected static MethodNamingHelper<DataSchemaBean.StorageSchemaBean> _disk_fields_logging = _logging_fields.nested(ManagementSchemaBean::storage_schema, DataSchemaBean.StorageSchemaBean.class);
	final protected static MethodNamingHelper<DataSchemaBean.StorageSchemaBean.StorageSubSchemaBean> _disk_fields_raw_logging = _disk_fields_logging.nested(DataSchemaBean.StorageSchemaBean::raw, DataSchemaBean.StorageSchemaBean.StorageSubSchemaBean.class);
	final protected static MethodNamingHelper<DataSchemaBean.StorageSchemaBean.StorageSubSchemaBean> _disk_fields_json_logging = _disk_fields_logging.nested(DataSchemaBean.StorageSchemaBean::json, DataSchemaBean.StorageSchemaBean.StorageSubSchemaBean.class);
	final protected static MethodNamingHelper<DataSchemaBean.StorageSchemaBean.StorageSubSchemaBean> _disk_fields_px_logging = _disk_fields_logging.nested(DataSchemaBean.StorageSchemaBean::processed, DataSchemaBean.StorageSchemaBean.StorageSubSchemaBean.class);
	...
	public void setup() {
		if (!_bucket_crud.isSet()) {
			...
			//Optimize the logging fields
			writable_crud.optimizeQuery(Arrays.asList(_time_fields_logging.field(DataSchemaBean.TemporalSchemaBean::exist_age_max))).join();
			writable_crud.optimizeQuery(Arrays.asList(_disk_fields_raw_logging.field(DataSchemaBean.StorageSchemaBean.StorageSubSchemaBean::exist_age_max))).join();
			writable_crud.optimizeQuery(Arrays.asList(_disk_fields_json_logging.field(DataSchemaBean.StorageSchemaBean.StorageSubSchemaBean::exist_age_max))).join();
			writable_crud.optimizeQuery(Arrays.asList(_disk_fields_px_logging.field(DataSchemaBean.StorageSchemaBean.StorageSubSchemaBean::exist_age_max))).join();
		}
	}
	...
	public void onReceive(final Object message) throws Exception {
		...
		if (String.class.isAssignableFrom(message.getClass())) { // tick!
			...
			final QueryComponent<DataBucketBean> query = CrudUtils.anyOf(DataBucketBean.class)
					...
					.withPresent(_time_fields_logging.field(DataSchemaBean.TemporalSchemaBean::exist_age_max))
					.withPresent(_disk_fields_raw_logging.field(DataSchemaBean.StorageSchemaBean.StorageSubSchemaBean::exist_age_max))
					.withPresent(_disk_fields_json_logging.field(DataSchemaBean.StorageSchemaBean.StorageSubSchemaBean::exist_age_max))
					.withPresent(_disk_fields_px_logging.field(DataSchemaBean.StorageSchemaBean.StorageSubSchemaBean::exist_age_max))
					;
