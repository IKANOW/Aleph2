...
/** Optional config bean for dedup
 * @author Alex
 */
public class DedupConfigBean {

	/** Allows users to override the doc schema in order to use the dedup service as a standalone job
	 * @return
	 */
	public DocumentSchemaBean doc_schema_override() { return doc_schema_override; }
	
	private DocumentSchemaBean doc_schema_override;
}
