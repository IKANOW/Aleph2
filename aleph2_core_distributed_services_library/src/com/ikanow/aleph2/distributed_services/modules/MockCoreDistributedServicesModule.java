...
/** Mock module, injects the config bean into the mock CDS
 * @author Alex
 */
public class MockCoreDistributedServicesModule extends CoreDistributedServicesModule {
	 ...
	 */
	@Inject
	public MockCoreDistributedServicesModule() {
	}
}
