...
public interface IAccessContext extends IServiceContext {	
	 ...
	 */
	CompletableFuture<BasicMessageBean> subscribeToBucket(DataBucketBean bucket, Optional<String> stage, Consumer<JsonNode> on_new_object_callback);
	 ...
	 * @return a future that completes when the subscription has occurred, describing its success or failure
	 */
	CompletableFuture<BasicMessageBean> subscribeToAnalyticThread(AnalyticThreadBean analytic_thread, Optional<String> stage, Consumer<JsonNode> on_new_object_callback);
	 ...
	 */
	CompletableFuture<Stream<JsonNode>> getObjectStreamFromBucket(DataBucketBean bucket, Optional<String> stage);
	 ...
	 * @return a future returning stream of Json nodes as soon as the connection is established
	 */
	Stream<JsonNode> getObjectStreamFromAnalyticThread(AnalyticThreadBean analytic_thread, Optional<String> stage);	
