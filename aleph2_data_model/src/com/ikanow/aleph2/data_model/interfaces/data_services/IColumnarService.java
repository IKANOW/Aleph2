 ...
 * @author alex
 */
public interface IColumnarService extends IUnderlyingService, IDataServiceProvider {
	 ...
	 */
	Tuple2<String, List<BasicMessageBean>> validateSchema(final DataSchemaBean.ColumnarSchemaBean schema, final DataBucketBean bucket);	
}
