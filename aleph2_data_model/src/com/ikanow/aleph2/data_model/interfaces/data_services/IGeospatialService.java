 ...
 * @author alex
 */
public interface IGeospatialService extends IUnderlyingService, IDataServiceProvider {
	 ...
	 */
	Tuple2<String, List<BasicMessageBean>> validateSchema(final DataSchemaBean.GeospatialSchemaBean schema, final DataBucketBean bucket);
}
