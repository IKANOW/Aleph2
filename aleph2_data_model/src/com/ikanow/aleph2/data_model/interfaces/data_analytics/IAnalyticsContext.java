...
public interface IAnalyticsContext {
	 ...
	 */
	@NonNull
	CompletableFuture<BasicMessageBean> subscribeToBucket(final @NonNull DataBucketBean bucket, final @NonNull Optional<String> stage, final Consumer<JsonNode> on_new_object_callback);
	 ...
	 */
	@NonNull
	CompletableFuture<BasicMessageBean> subscribeToAnalyticThread(final @NonNull AnalyticThreadBean analytic_thread, final @NonNull Optional<String> stage, final Consumer<JsonNode> on_new_object_callback);
	 ...
	 */
	@NonNull
	CompletableFuture<Stream<JsonNode>> getObjectStreamFromBucket(final @NonNull DataBucketBean bucket, final @NonNull Optional<String> stage);
	 ...
	 */
	@NonNull
	Stream<JsonNode> getObjectStreamFromAnalyticThread(final @NonNull AnalyticThreadBean analytic_thread, final @NonNull Optional<String> stage);
	 ...
	 */
	@NonNull
	List<String> getAnalyticsContextLibraries(final @NonNull Optional<Set<Class<?>>> services);
	 ...
	 */
	@NonNull
	String getAnalyticsContextSignature(final @NonNull Optional<AnalyticThreadBean> analytic_thread);
	 ...
	 */
	@NonNull
	CompletableFuture<Map<String, String>> getAnalyticsLibraries(final @NonNull Optional<AnalyticThreadBean> analytic_thread);
	 ...
	 */
	@NonNull
	<S> ICrudService<S> getThreadObjectStore(final @NonNull Class<S> clazz, final @NonNull Optional<AnalyticThreadBean> analytic_thread, final @NonNull Optional<String> sub_collection, final boolean auto_apply_prefix);
	 ...
	 */
	@NonNull
	CompletableFuture<AnalyticThreadStatusBean> getThreadStatus(final @NonNull Optional<AnalyticThreadBean> analytic_thread);
	 ...
	 */
	void logStatusForThreadOwner(final @NonNull Optional<AnalyticThreadBean> analytic_thread, final @NonNull BasicMessageBean message, final boolean roll_up_duplicates);
	 ...
	 */
	void logStatusForThreadOwner(final @NonNull Optional<AnalyticThreadBean> analytic_thread, final @NonNull BasicMessageBean message);
	 ...
	 * @param analytic_thread An optional analytic thread - if there is no ambiguity in the analytic thread then Optional.empty() can be passed (Note that the behavior of the context if called on another analytic thread than the one currently being processed is undefined) 
	 */
	void emergencyDisableThread(final @NonNull Optional<AnalyticThreadBean> analytic_thread);
	 ...
	 */
	void emergencyQuarantineThread(final @NonNull Optional<AnalyticThreadBean> analytic_thread, final @NonNull String quarantine_duration);
