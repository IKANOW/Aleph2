...
public interface IAnalyticsContext {
	 ...
	 */
	@NonNull
	Future<BasicMessageBean> subscribeToBucket(final @NonNull DataBucketBean bucket, final @NonNull Optional<String> stage, final Consumer<JsonNode> on_new_object_callback);
	 ...
	 */
	@NonNull
	Future<BasicMessageBean> subscribeToAnalyticThread(final @NonNull AnalyticThreadBean analytic_thread, final @NonNull Optional<String> stage, final Consumer<JsonNode> on_new_object_callback);
	 ...
	 */
	@NonNull
	Future<Stream<JsonNode>> getObjectStreamFromBucket(final @NonNull DataBucketBean bucket, final @NonNull Optional<String> stage);
	 ...
	 */
	@NonNull
	Future<Map<String, String>> getAnalyticsLibraries(final @NonNull Optional<AnalyticThreadBean> analytic_thread);
	 ...
	 */
	@NonNull
	Future<AnalyticThreadStatusBean> getThreadStatus(final @NonNull Optional<AnalyticThreadBean> analytic_thread);
