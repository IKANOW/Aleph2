...
public interface ICrudService<O> {
	 ...
	 * @param unique_spec A specification (must describe at most one object) generated by CrudUtils.allOf(o) (all fields must be match) or CrudUtils.anyOf(o) (any fields must match) together with extra fields generated by .withAny(..), .withAll(..), present(...) or notPresent(...)   
	 ...
	 * @return A future containing the number of matching objects 
	 */
	Future<Long> countObjectsBySpec(CrudUtils.@NonNull MultiQueryComponent<O> multi_spec, @NonNull List<String> field_list);

	/** Counts the number of objects specified by the spec (all fields returned)
	 * @param A specification that must be initialized via CrudUtils.anyOf(new O()) and then the desired fields added via .exists(<field or getter>)
	 * @return A future containing the number of matching objects 
	 */
	Future<Long> countObjectsBySpec(CrudUtils.@NonNull MultiQueryComponent<O> multi_spec);
	 ...
	 * @return a future describing if the update was successful
	 */
	Future<Boolean> updateObjectBySpec(CrudUtils.@NonNull MultiQueryComponent<O> unique_multi_spec, Optional<O> set, Optional<O> add, Optional<O> remove);
	 ...
	 * @return a future describing the number of objects updated
	 */
	Future<Long> updateObjectsBySpec(CrudUtils.@NonNull MultiQueryComponent<O> multi_spec, Optional<O> set, Optional<O> add, Optional<O> remove);
	 ...
	 * @return a future describing if the update was successful
	 */
	Future<Boolean> updateAndReturnObjectBySpec(CrudUtils.@NonNull MultiQueryComponent<O> unique_multi_spec, Optional<O> set, Optional<O> add, Optional<O> remove, Optional<Boolean> before_updated);
	 ...
	 * @return a future describing the number of objects updated
	 */
	Future<Long> deleteObjectsBySpec(CrudUtils.@NonNull MultiQueryComponent<O> multi_spec);
