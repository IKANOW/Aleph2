...
public interface ICrudService<O> {
	 ...
	 */
	@NonNull 
	Future<Boolean> updateObjectById(final @NonNull Object id, final Optional<O> set, final Optional<QueryComponent<O>> add, final Optional<QueryComponent<O>> remove);
	 ...
	 */
	@NonNull 
	Future<Boolean> updateObjectBySpec(final @NonNull QueryComponent<O> unique_spec, final Optional<Boolean> upsert, final Optional<O> set, final Optional<QueryComponent<O>> add, final Optional<QueryComponent<O>> remove);
	 ...
	 */
	@NonNull 
	Future<Long> updateObjectsBySpec(final @NonNull QueryComponent<O> spec, final Optional<Boolean> upsert, final Optional<O> set, final Optional<QueryComponent<O>> add, final Optional<QueryComponent<O>> remove);
	 ...
	 */
	@NonNull 
	Future<Optional<O>> updateAndReturnObjectBySpec(final @NonNull QueryComponent<O> unique_spec, final Optional<Boolean> upsert, final Optional<O> set, final Optional<QueryComponent<O>> add, final Optional<QueryComponent<O>> remove, final Optional<Boolean> before_updated, final @NonNull List<String> field_list, final boolean include);
