...
public interface ICrudService<O> {
	 ...
	 */
	@NonNull 
	Future<Optional<O>> getObjectBySpec(CrudUtils.@NonNull QueryComponent<O> unique_spec, @NonNull List<String> field_list, boolean include);
	 ...
	 */
	@NonNull 
	Future<Cursor<O>> getObjectsBySpec(CrudUtils.@NonNull QueryComponent<O> spec);
	 ...
	 */
	@NonNull 
	Future<Cursor<O>> getObjectsBySpec(CrudUtils.@NonNull QueryComponent<O> spec, @NonNull List<String> field_list, boolean include);
	 ...
	 */
	@NonNull 
	Future<Boolean> updateAndReturnObjectBySpec(CrudUtils.@NonNull QueryComponent<O> unique_spec, Optional<O> set, Optional<O> add, Optional<O> remove, Optional<Boolean> before_updated, @NonNull List<String> field_list, boolean include);
