...
public interface ICrudService<O> {
	 ...
	 */
	@NonNull 
	Future<Boolean> updateObjectBySpec(@NonNull QueryComponent<O> unique_spec, Optional<O> set, Optional<QueryComponent<O>> add, Optional<QueryComponent<O>> remove, Optional<Boolean> upsert);
	 ...
	 */
	@NonNull 
	Future<Long> updateObjectsBySpec(@NonNull QueryComponent<O> spec, Optional<O> set, Optional<QueryComponent<O>> add, Optional<QueryComponent<O>> remove);
	 ...
	 */
	@NonNull 
	Future<Boolean> updateAndReturnObjectById(String id, Optional<O> set, Optional<QueryComponent<O>> add, Optional<QueryComponent<O>> remove, Optional<Boolean> before_updated);
	 ...
	 */
	@NonNull 
	Future<Boolean> updateAndReturnObjectBySpec(@NonNull QueryComponent<O> unique_spec, Optional<O> set, Optional<QueryComponent<O>> add, Optional<QueryComponent<O>> remove, Optional<Boolean> before_updated);
	 ...
	 */
	@NonNull 
	Future<Boolean> updateAndReturnObjectBySpec(@NonNull QueryComponent<O> unique_spec, Optional<O> set, Optional<QueryComponent<O>> add, Optional<QueryComponent<O>> remove, Optional<Boolean> before_updated, @NonNull List<String> field_list, boolean include);
