...
public class SampleDataWarehouseService implements IDataWarehouseService {
	...
	@Override
	public Tuple2<String, List<BasicMessageBean>> validateSchema(DataWarehouseSchemaBean schema, final DataBucketBean bucket) {
