...
public class TestDataSchemaBean {
	...
	public void testAccessors() {
		...
		assertEquals("Columnar bean field_include_regex", columnar_bean.field_include_pattern(), "field_include_regex");
		assertEquals("Columnar bean field_exclude_regex", columnar_bean.field_exclude_pattern(), "field_exclude_regex");
